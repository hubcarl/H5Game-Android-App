...
public class WDJMainActivity extends Activity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    findViewById(R.id.show_apps_button).setOnClickListener(new OnClickListener() {
      ...
      public void onClick(View v) {
        Ads.showAppWall(WDJMainActivity.this, TAG_LIST);
    ...
    findViewById(R.id.show_app_widget_button).setOnClickListener(new OnClickListener() {
      ...
      @Override
      public void onClick(View v) {
        Ads.showAppWidget(WDJMainActivity.this, null, TAG_INTERSTITIAL_FULLSCREEN,
    ...
    findViewById(R.id.show_app_widget_button_exception).setOnClickListener(
        new OnClickListener() {
          ...
          @Override
          public void onClick(View v) {
            Ads.showAppWidget(WDJMainActivity.this, null, "A-TAG", Ads.ShowMode.FULL_SCREEN);
  ...
  void showBannerAd() {
    ...
    adBanner = Ads.showBannerAd(this, (ViewGroup) findViewById(R.id.banner_ad_container),TAG_BANNER);
