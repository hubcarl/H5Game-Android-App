 ...
 */
public class DBCacheTask extends AsyncTask<String, Void, Boolean>{
    ...
    public DBCacheTask(Context context,String tabName, String[] tabCols, String[] primaryKeys){
            ...
            for(int i=0;i<jsonArray.length();i++){
                ...
                for(String colName : tabCols){
                    try {
                        ...
                        Log.e(">>>>>>>>>>>>>h5game cache json error:", e.toString());
                    }
                }
